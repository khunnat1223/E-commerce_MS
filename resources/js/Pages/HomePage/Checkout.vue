                  ...
                  <div class="flex-wrap md:flex">
                    <div class="mx-auto">
                      ...
                      <div>
                        ...
                        <p class="mt-1 font-medium text-center text-red-500">
                    ...
                    <!-- Step Checkout -->
                    <div class="max-w-sm mt-8 md:mt-0 md:ml-10 md:w-2/3">
                      <div class="relative flex pb-12">
                        ...
                        <div class="flex-grow pl-4">
                          ...
                          >
                            ដំបូងលោកអ្នកស្កេន
                            <br />
                            <b class="text-sm">QR CODE </b>ហើយធ្វើការទូរទាត់
                          </p>
                        </div>
                      </div>
                      <div class="relative flex pb-12">
                        ...
                        <div class="flex-grow pl-4">
                          ...
                          >
                            Upload វិក្កយបត្រ ដែលបានទូរទាត់រួចនោះ
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="flex-grow pl-4">
                        ...
                        >
                          <u class="text-base font-bold text-red-700">ចំណាំ៖</u>
