...
<template>
    <footer class="pt-4 pb-10 bg-stone-400 sm:py-10 lg:py-12">
        <div class="px-4 mx-auto max-w-screen-2xl md:px-8">
            ...
            >
                ...
                <div>
                    <div
                        class="mb-4 font-bold tracking-widest text-black uppercase"
                    >
                        Follow Us
                    </div>
                    ...
                    <nav class="flex flex-col gap-4">
                        <div>
                            <a
                                href="#"
                                class="flex items-center text-white transition duration-100 hover:text-yellow-300 active:text-yellow-600"
                                ><svg
                        ...
                        <div>
                            <a
                                href="#"
                                class="flex items-center text-white transition duration-100 hover:text-yellow-300 active:text-yellowbg-red-600"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    x="0px"
                ...
                <div>
                    <div
                        class="mb-4 font-bold tracking-widest text-gray-800 uppercase"
                    >
                        Contact Us
                    </div>
                    ...
                    <nav class="flex flex-col gap-4">
                        <div>
                            <a
                                href="#"
                                class="flex text-white transition duration-100 hover:text-yellow-300 active:text-yellow-600"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    x="0px"
