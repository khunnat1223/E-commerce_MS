...
// const cart = computed(() => props.cart || { items: [], total: 0, products: [], count: 0 });
defineProps({
  userAddress: Object,
});
...
const discount = computed(() => usePage().props.cart.discounts);
  ...
  <HomeLayout>
    ...
    <div>
      <div class="relative max-w-screen-lg px-4 mx-auto md:px-8">
        <div class="">
          <h2
            class="mb-2 text-2xl font-bold text-center text-gray-800 lg:text-3xl"
          >
            Cart Lists
          </h2>
        </div>
        <div
          class="block gap-2 mb-6 lg:mr-64 sm:mb-8 md:gap-1 h-96 mt-5 overflow-auto"
            ...
            <div class="flex flex-col justify-between flex-1 py-2">
              <div>
                <a
                  ...
                  >{{ product.title }}</a
                >
                <span class="block w-80 truncate"
        ...
        <div class="flex flex-col items-end lg:absolute top-14 -end-16">
          ...
          >
            <h2
              class="text-lg font-semibold text-center mb-6 mt-4 text-gray-900 dark:text-white"
            >
              Order summary
            </h2>
            <div class="space-y-4">
