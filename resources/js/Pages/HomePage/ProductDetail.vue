<template>
          ...
          <div class="grid gap-8 md:grid-cols-2">
            ...
            <div class="md:py-8">
              ...
              <div class="mb-4">
                ...
                <form class="mt-2">
                  <label for="counter-input" class="block mb-1 text-sm font-bold text-gray-900 dark:text-white">
                    Choose quantity:
                  </label>
  ...
  const props = defineProps({
    product: Object,
    users: Object, // If you need users prop, otherwise you can remove this
  });

//   const router = useRouter();

  // Reactive property for the current image
  const currentImage = ref(props.product.product_images[0]);
  ...
  // Reactive property for the quantity input
  ...
  const productData = {
    quantity: quantity.value // Pass only quantity, not product_id
  };
