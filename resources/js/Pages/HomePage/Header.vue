          ...
          >
            ...
            <div  v-if="auth.user" class="flex">
                ...
                <div class="hover:bg-gray-600 w-10 h-10 pl-2 pt-2 -mt-2 rounded-lg">
                    <svg class="w-6 h-6 text-white dark:text-yellow-400 dark:hover:text-yellow-300 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
