...
<template>
  <HomeLayout>
    <div class="px-24 relative shadow-md sm:rounded-lg">
      <!-- Path for Back -->
      ...
      <div class="relative bg-gray-200 shadow-md sm:rounded-lg">
        <div class="flex flex-col items-center py-10">
          <img
            v-if="!users.profile || users.profile.profile === ''"
            class="rounded-full shadow-lg w-44 h-44 bg-slate-100"
            src="/profile.png"
            alt="Profile Image"
          />
          <img
            v-else
            class="rounded-full object-cover w-44 h-44 border-4 border-white bg-slate-100"
            :src="profileUrl"
            alt="Profile Image"
          />
        </div>
        <div class="py-4X sm:py-8">
          <div class="px-4 pl-4 mx-auto max-w-screen-2xl md:pl-8">
            ...
            <div class="grid px-24 mx-auto">
              ...
              >
                <div class="flex">
                  ...
                  <h1 class="ml-2">{{ $t("Orders History") }}</h1>
                </div>
              ...
              <a href="#" class="flex px-4 py-2 hover:text-yellow-600">
                <br /><u>{{ $t("Ongoing Orders") }} </u>
                <span
                  class="bg-red-600 ml-1 px-2 rounded-full text-white text-sm justify-center flex items-center"
                  >{{ ongoing }}</span
                >
              </a>
              <a href="#" class="flex px-4 py-2 hover:text-yellow-600">
                <br /><u>{{ $t("Completed Orders") }} </u>
                <span
                  class="bg-green-600 ml-1 px-2 rounded-full text-white text-sm justify-center flex items-center"
                  >{{ complet }}</span
                >
              </a>
            </div>
            <div class="grid px-24 mx-auto">
              ...
              <div
                class="cursor-pointer group flex hover:bg-hovercolorBG rounded-lg focus:ring-4"
                aria-expanded="false"
              ...
              >
                ...
                <!-- Dropdown -->
                <div
                  class="z-50 hidden my-5 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
