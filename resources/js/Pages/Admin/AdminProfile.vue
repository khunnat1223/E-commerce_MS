    ...
    <div class="px-10 ">
      ...
      <div class="relative bg-gray-200 shadow-md sm:rounded-lg">
        <div class="flex flex-col items-center py-10">
          <img
            v-if="!auth.user.profile.profile || auth.user.profile.profile  === ''"
        ...
        <div class="py-4X sm:py-8">
          <div class="px-4 pl-4 mx-auto max-w-screen-2xl md:pl-8">
            <div class="grid px-24 mx-auto">
              ...
              <div class="flex px-4 py-2">
                {{$t('Phone Number')}}:
                <p>&ensp; {{auth.user.profile.phone ? auth.user.profile.phone : "" }}</p>
              </div>
              <div class="flex px-4 py-2">
                {{$t('Address')}}:
                <p>&ensp; {{ auth.user.profile ? auth.user.profile.address : "" }}</p>
              </div>
            </div>
            <div class="grid px-24 mx-auto">
              <Link
