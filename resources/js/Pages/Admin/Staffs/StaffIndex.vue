...
const ComfimDeleteStaff = (id) => {
  showComfirmDeleteStaffModel.value = true;
  staffid.value = id;
};

const closeModal = () => {
  showComfirmDeleteStaffModel.value = false;
};

const DeleteStaff = () => {
  form.delete(route("staffs.destroy", staffid.value), {
        ...
        <Table class="w-full">
          <template #header>
            <TableRow>
              ...
              <TableHeaderCell>{{ $t("sex") }}</TableHeaderCell>
              <TableHeaderCell>{{ $t("Phone") }}</TableHeaderCell>
              <TableHeaderCell>{{ $t("salary") }}</TableHeaderCell>
          ...
          <template #default>
            ...
            >
              ...
              <TableDataCell>${{ staff.salary }}</TableDataCell>
              <TableDataCell>
                <span class="text-yellow-500 flex">
                  ...
                  <button
                    ...
                    @click="ComfimDeleteStaff(staff.id)"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Modal
                    :show="showComfirmDeleteStaffModel"
                    @click="closeModal"
                  >
