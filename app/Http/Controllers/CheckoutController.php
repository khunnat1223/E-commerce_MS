    ...
    public function store(Request $request)
{
    ...
    if (!is_array($carts)) {
        return redirect()->route('home.index')->with('error', 'Invalid cart data format.');
    }

    if (!is_array($products)) {
        return redirect()->route('home.index')->with('error', 'Invalid product data format.');
    }
    ...
    return redirect()->route('home.index')->with('success', 'Order and payment created successfully!');
}
